    ...
    const radioArr = [
        ...
        },
        {
            ...
            img: (
                ...
                >
                    <path
                        d="M52.736 6.144c20.992 0 39.424 15.36 43.008 36.352l0.512 7.168v877.568H977.92c20.992 0 39.424 15.36 43.008 36.352l0.512 7.168c0 20.992-15.36 39.424-36.352 43.008H9.216V49.152c0-23.552 19.456-43.008 43.52-43.008z"
                        fill="#1296db"
                        p-id="2003"
                        data-spm-anchor-id="a313x.7781069.0.i0"
                    ></path>
                    <path
                        d="M640 322.048L499.2 442.368c-4.096 3.584-9.728 4.096-13.824 1.024l-153.6-91.136c-4.608-2.56-10.752-2.048-14.336 1.536L167.936 500.736v165.376l148.992-144.384c3.584-4.096 9.728-4.608 14.336-1.536l176.64 103.936c4.096 2.048 9.216 2.048 12.8-0.512l143.36-98.816c1.024-0.512 2.56-1.536 3.584-1.536l292.352-78.336V235.52l-315.392 83.456c-1.536 0.512-3.072 1.536-4.608 3.072z"
                        fill="#F59D0D"
                        opacity=".6"
                        p-id="2004"
                    ></path>
                    <path
                        d="M664.576 571.904L522.752 670.72c-3.584 2.56-8.704 2.56-12.8 0.512l-178.688-103.936c-4.608-2.56-10.752-2.048-14.336 1.536 0 0-149.504 144.384-149.504 147.456v120.32h792.064V489.472l-291.84 80.896-3.072 1.536z"
                        fill="#d4237a"
                        p-id="2005"
